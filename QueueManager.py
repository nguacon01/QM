...
class Job(object):
    ...
    def run2(self):
        ...
        if True:
            ...
            ok =  True
            # if return code is none-zero code, that means subprocess has error
            if self.retcode != 0:
                ok = False
...
class Jobs(object):
    ...
    def _get_jobs_folder_path(self, type):
        ...
        if type==QUEUE_JOBS:
            ...
            # return all jobs in queue, including error jobs, done jobs, running jobs and jobs in queue
    ...
    # with a form of name: 2021-02-09T15:50:13-job_name-of-project-folder_name-of-mscf-file.j
